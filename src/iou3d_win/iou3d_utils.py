...
#function added from lib.utils.kitti_utils to avoid importing.
...
def boxes_iou3d_gpu(boxes_a, boxes_b):
    ...
    boxes_a_bev = boxes3d_to_bev_torch(boxes_a) #replacing above line to use direct function call.
    boxes_b_bev = boxes3d_to_bev_torch(boxes_b) #replacing above line to use direct function call.
