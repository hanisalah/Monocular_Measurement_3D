...
paths = {'root_path' : app_path, 'data_dir' : app_path+'/data/', 'image_dir' : app_path + '/data/dset_imgs/', 'calib_dir' : app_path + '/data/dset_calib/',
        'label_dir' : app_path + '/data/dset_labels/', 'working_dir' : app_path + '/data/anns/', 'demo' : app_path + '/data/predictions/',
        'exp_dir' : app_path +'/data/model/exp/', 'save_dir' : app_path +'/data/model/exp/default/', 'debug_dir' : app_path + '/data/model/exp/debug/',
        'results_dir' : app_path + '/data/model/exp/results/', 'model_dir' : app_path +'/data/model/exp/default/','master_calib': app_path+'/data/cam_calib_master_files/'}
...
if train_enable == True and flag =='Train':
    ...
    calibs = read_files(paths['master_calib']+'*.txt')
