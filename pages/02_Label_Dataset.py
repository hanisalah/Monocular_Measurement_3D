...
if st.session_state.df_ix >= 0:
    ...
    img_obj=None
    canvas_key = 'canvas'
img_strm = st.file_uploader('test',type=['png','jpeg','jpg'], key='test')
canvas_result = st_canvas(fill_color='rgba(0,165,255,0.3)', stroke_width=3, stroke_color='#000000', background_color='#eee',
                            background_image=Image.open(img_strm) if img_strm else None, update_streamlit=True, height=400, width=700,
                            drawing_mode='rect', point_display_radius=0, key='canvas')
